    ...
    <div className="px-0 lg:px-8 pb-8 lg:pb-20">
      <div className="flex flex-row  max-w-fit ">
        <div className="flex flex-row rounded-none sm:rounded-l-2xl bg-orange-200">
          <h3 className="text-sm xs:text-md sm:text-lg md:text-xl lg:text-3xl text-orange-950 text-nowrap font-semibold font-instrument-sans py-4 md:py-8 px-3 md:px-6">
            Coffee Beans <br /> from Different <br /> Regions
          </h3>
        </div>
        <div className="flex flex-row bg-indigo-50">
          <h3 className="text-sm xs:text-md sm:text-lg md:text-xl lg:text-3xl text-orange-950 font-semibold font-instrument-sans py-4 md:py-8 px-3 md:px-6">
